...
int main(void)
{
	int integerArrayTest1[5] = {3, 1, -4, 2, 5 };
	int integerArrayTest2[10] = { 100, 87, -14, 56, -200, 3, 14, -2, 34, 20 };
	int intLowHighAnswer1[5] = { -4, 1, 2, 3, 5 };
	int intLowHighAnswer2[10] = { -200, -14, -2, 3, 14, 20, 34, 56, 87, 100 };
	int intHighLowAnswer1[5] = { 5, 3, 2, 1, -4 };
	int intHighLowAnswer2[10] = { 100, 87, 56, 34, 20, 14, 3, -2, -14, -200 };
	int intAbsLowHighAnswer1[5] = { 1, 2, 3, 4, 5 };
	int intAbsLowHighAnswer2[10] = { 2, 3, 14, 14, 20, 34, 56, 87, 100, 200 };
	int intAbsHighLowAnswer1[5] = { 5, 4, 3, 2, 1 };
	int intAbsHighLowAnswer2[10] = { 200, 100, 87, 56, 34, 20, 14, 14, 3, 2 };

	int ArrayTestAnswers[8] = { 4, 6, 3, 7, 27, 18, 36, 23 };

	int(*lowHigh_ptr)(int x, int y);
	int(*highLow_ptr)(int x, int y);
	int(*absLow_ptr)(int x, int y);
	int(*absHigh_ptr)(int x, int y);

	lowHigh_ptr = &low_to_high_compare;
	highLow_ptr = &high_to_low_compare;
	absLow_ptr = &absolute_low_to_high_compare;
	absHigh_ptr = &absolute_high_to_low_compare;

	int * ArrayTest_ptr[2] = { integerArrayTest1, integerArrayTest2 };
	int * compareFunctions_ptr[4] = { &low_to_high_compare, &high_to_low_compare, &absolute_low_to_high_compare, &absolute_high_to_low_compare };
	...
	int j = 0;
		...
		printf("%d\n", bubble_sort(*ArrayTest_ptr, 5, *(compareFunctions_ptr)));
		printf("%d\n", bubble_sort(*ArrayTest_ptr, 5, *(compareFunctions_ptr + 1)));
		printf("%d\n", bubble_sort(*ArrayTest_ptr, 5, *(compareFunctions_ptr + 2)));
		printf("%d\n", bubble_sort(*ArrayTest_ptr, 5, *(compareFunctions_ptr + 3)));
	
		printf("%d\n", bubble_sort(*(ArrayTest_ptr + 1), 10, *(compareFunctions_ptr)));
		printf("%d\n", bubble_sort(*(ArrayTest_ptr + 1), 10, *(compareFunctions_ptr + 1)));
		printf("%d\n", bubble_sort(*(ArrayTest_ptr + 1), 10, *(compareFunctions_ptr + 2)));
		printf("%d\n", bubble_sort(*(ArrayTest_ptr + 1), 10, *(compareFunctions_ptr + 3)));
